# APEX MOBILITY - BUSINESS CONTEXT
## Overview
Apex Mobility is a fictitious company modeled on an open-source relational database. The company manufactures and retails bicycles and related products globally.<br> 
Its operations span multiple business domains, each supported by a structured relational database.
